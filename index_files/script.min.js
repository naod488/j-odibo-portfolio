jQuery(document).ready(function (r) {
    ...
    function e(t) {
        var i = !1;
        (t.is(r.material.options.checkboxElements) || t.is(r.material.options.radioElements)) && (i = !0), t.closest("label").hover(function () {
            var t, e, a = r(this).find("input"), o = a.prop("disabled");
    ...
    r.expr[":"].notmdproc = function (t) {
        ...
        options: {validate: !0, input: !0, ripples: !0, checkbox: !0, togglebutton: !0, radio: !0, arrive: !0, autofill: !1, withRipples: [".btn:not(.btn-link)", ".card-image", ".navbar a:not(.withoutripple)", ".dropdown-menu a", ".nav-tabs a:not(.withoutripple)", ".withripple", ".pagination li:not(.active):not(.disabled) a:not(.withoutripple)"].join(","), inputElements: "input.form-control, textarea.form-control, select.form-control", checkboxElements: ".checkbox > label > input[type=checkbox], label.checkbox-inline > input[type=checkbox]", togglebuttonElements: ".togglebutton > label > input[type=checkbox]", radioElements: ".radio > label > input[type=radio], label.radio-inline > input[type=radio]"}, checkbox: function (t) {
            ...
            r(t || this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function () {
                var a = r(this), o = a.closest(".form-group");
                ...
                if (r.each({"input-lg": "form-group-lg", "input-sm": "form-group-sm"}, function (t, e) {
            ...
            r(document).on("keydown paste", ".form-control", function (t) {
                ...
                var t = r(this), e = t.closest(".form-group"), a = void 0 === t[0].checkValidity || t[0].checkValidity();
                ...
                var t = r(this).closest(".form-group"), a = "";
    ...
    l.hestiaFeatures = {
        ...
        debounce: function (o, i, n) {
            var r;
            return function () {
                var t = this, e = arguments, a = n && !r;
                clearTimeout(r), r = setTimeout(function () {
                    r = null, n || o.apply(t, e)
                }, i), a && o.apply(t, e)
            }
        }, isElementInViewport: function (t) {
            var e = l(t), a = l(window).scrollTop(), o = a + l(window).height(), i = Math.round(e.offset().top), n = i + e.height();
            return i < o && a < n
        ...
        init: function () {
            ...
            l(".hestia-toggle-search").on("click", function () {
                ...
                t.find(".hestia-nav-search").addClass("is-focused"), t.find(".hestia-nav-search").find(".search-field").focus(), l(this).find("i").fadeOut(200, function () {
            ...
            l("#portfolio").find('a[data-toggle="modal"]').on("click", function (t) {
                ...
                l.ajax({
                           url: requestpost.ajaxurl, type: "post", data: {action: "hestia_get_portfolio_item_data", pid: e}, success: function (t) {
            ...
            var t = l(".navbar-fixed-top").outerHeight(), e = window.matchMedia("(max-width: 600px)");
            if (l("#wpadminbar").length && e.matches ? (l(".wrapper.classic-blog").find(".main").css("margin-top", t - 46), l(".carousel .item .container").css("padding-top", t + 50 - 46), l(".home.page.page-template-default .navbar").hasClass("no-slider") && l(".home.page.page-template-default .main").css("margin-top", t - 46)) : (l(".header-layout-classic-blog").find(".main").css("margin-top", t), l(".carousel .item .container").css("padding-top", t + 50), l(".home.page.page-template-default .navbar").hasClass("no-slider") && l(".home.page.page-template-default .main").css("margin-top", t)), 768 < l(window).width()) {
                ...
                var a = l(".single-product .page-header").height(), o = a + 100;
            ...
            if ((!this.inIframe() || !this.isMobileUA()) && 0 < l(".home .carousel").length) {
                var t = l(".page-header"), e = l(window).width(), a = l(window).height();
            ...
            l(window).on("scroll", function () {
                var t = window.pageYOffset, e = l(".page-header"), a = 0;
                (a = 0 < e.length ? e.height() : 0 < (a = (e = l(".container")).offset().top - l(".navbar").height()) ? a : 0) <= t && 0 === o && (l(".hestia-scroll-to-top").addClass("hestia-fade"), o = 1), t <= a && 1 === o && (l(".hestia-scroll-to-top").removeClass("hestia-fade"), o = 0)
            ...
            void 0 !== l(".contact_submit_wrap") && l(".pirate-forms-submit-button").addClass("btn btn-primary"), void 0 !== l(".form_captcha_wrap") && (l(".form_captcha_wrap").hasClass("col-sm-4") && l(".form_captcha_wrap").removeClass("col-sm-6"), l(".form_captcha_wrap").hasClass("col-lg-6") && l(".form_captcha_wrap").removeClass("col-lg-6"), l(".form_captcha_wrap").addClass("col-md-12")), void 0 !== l("form") && l("form").addClass("form-group"), void 0 !== l("input") && (void 0 !== l('input[type="text"]') && l('input[type="text"]').addClass("form-control"), void 0 !== l('input[type="email"]') && l('input[type="email"]').addClass("form-control"), void 0 !== l('input[type="url"]') && l('input[type="url"]').addClass("form-control"), void 0 !== l('input[type="password"]') && l('input[type="password"]').addClass("form-control"), void 0 !== l('input[type="tel"]') && l('input[type="tel"]').addClass("form-control"), void 0 !== l('input[type="search"]') && l('input[type="search"]').addClass(
                "form-control"), void 0 !== l("input.select2-input") && l("input.select2-input").removeClass("form-control")), void 0 !== l("textarea") && l("textarea").addClass("form-control"), void 0 !== l(".form-control") && (l(".form-control").parent().addClass("form-group"), l(window).on("scroll", function () {
            ...
            var e = l(".alignfull"), a = l(".alignwide");
        ...
        init: function () {
            ...
            l('.navbar a[href*="#"], a.btn[href*="#"]').click(function () {
                if ("#" !== l(this).attr("href") && location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
                    var t = l(this.hash);
                    if ((t = t.length ? t : l("[name=" + this.hash.slice(1) + "]")).length) return l("html,body").animate({scrollTop: t.offset().top - l.utilitiesFunctions.verifyNavHeight()}, 1200), l(".navbar .navbar-collapse").hasClass("in") && l(".navbar .navbar-collapse.in").removeClass("in"), l("body").hasClass("menu-open") && (l("body").removeClass("menu-open"), l(".navbar-collapse").css("height", "0"), l(".navbar-toggle").attr("aria-expanded", "false")), !1
                }
            })
            ...
            l(window).on("scroll", function () {
                if (l("body").hasClass("home") && 751 <= l(window).width()) {
                    var n = l(window).scrollTop(), r = l(".navbar").outerHeight(), s = "no";
                    l("#carousel-hestia-generic, section").each(function () {
                        var t = "#" + l(this).attr("id"), e = l(this).offset().top, a = l(this).outerHeight(), o = e - r, i = e + a - r;
                        if (n + l.utilitiesFunctions.verifyNavHeight() >= o && n + l.utilitiesFunctions.verifyNavHeight() <= i) return s = "yes", l("nav .on-section").removeClass("on-section"), l('nav a[href$="' + t + '"]').parent("li").addClass("on-section"), !1;
    ...
    return function (t) {
        ...
        jQuery.hestiaFeatures.initMasonry(), jQuery.hestia.fixHeaderPadding(), jQuery.hestia.headerSpacingFrontpage(), jQuery.hestiaNavBarScroll.checkNavbarScrollPoint(), jQuery.navigation.repositionDropdowns(), e !== a && (jQuery.hestia.handleGutenbergAlignment(), a = e)
    }
}());